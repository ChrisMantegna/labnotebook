...
output:
  ...
  beamer_presentation:
    incremental: true
subtitle: FISH 510: Marine Orgnaism Resilience & Epigenetics
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = FALSE)

#update all of these sections - just took them to help me remember the structure and flow of bulding a presentation in Quarto. Also, remember to move to Weekly so that it will render correctly w/ the images and css files
