...
-   I set up the project log - a complete place for all notes with quick
    links to the work. I'm trying to keep everything a project needs in
    the same place rather than spread out over multiple platforms. We'll
    test and see if we're effective or complicating the current process.
